...
#define BS_UDB_0_5_0_CONFIG_VAL ((const uint8 CYFAR *)0x48000404u)
...
#define BS_IOPINS0_8_VAL ((const uint8 CYFAR *)0x4800048Cu)
...
#define BS_IOPINS0_4_VAL ((const uint8 CYFAR *)0x480004A0u)

/* IOPINS0_6 Address: CYREG_PRT6_DR Size (bytes): 10 */
#define BS_IOPINS0_6_VAL ((const uint8 CYFAR *)0x480004A8u)
...
uint8 CYXDATA * const CYCODE AMux_1__addrTable[8] = {
	(uint8 CYXDATA *)CYREG_PRT6_AG, (uint8 CYXDATA *)CYREG_DSM0_SW0, 
